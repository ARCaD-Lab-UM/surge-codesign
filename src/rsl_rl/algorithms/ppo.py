...
class PPO:
    ...
    def __init__(self,
        ...
        self.estimator_updates_per_ppo = estimator_updates_per_ppo

        # ROA scheduling parameters
        # TODO: Don't hardcode them here, make them configurable
        self.start_val, self.end_val, self.start_step, self.duration = 0.0, 0.05, 99999, 100000
        if resume:
        ...
        # print("⚠️  ESTIMATOR UPDATES PER PPO: {}".format(self.estimator_updates_per_ppo))
        # print("===========================================================\n")
    ...
    def update(self):
        ...
        for obs_batch, privileged_obs_batch, critic_obs_batch, true_estimated_obs_batch, scan_obs_batch, \
            ...
            old_mu_batch, old_sigma_batch, hid_states_batch, masks_batch in generator:
                ...
                # Estimator updates - can update multiple times on same batch
                batch_estimator_loss = 0
                for _ in range(self.estimator_updates_per_ppo):
                    ...
                    batch_estimator_loss += estimator_loss.item()

                # Average loss for this batch across all estimator updates
                estimator_loss_for_logging = batch_estimator_loss / self.estimator_updates_per_ppo
                ...
                mean_estimator_loss += estimator_loss_for_logging
