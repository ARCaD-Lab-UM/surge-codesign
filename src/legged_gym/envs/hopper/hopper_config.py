...
class HopperCfg( LeggedRobotCfg ):
    ...
    class domain_rand:
        ...
        # Randomize the swept UPS design params (ks, l0, l2, l4) per env during training so
        # the policy generalizes across designs. Codesign evaluation sets this to False.
        randomize_design = True
